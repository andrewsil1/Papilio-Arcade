...
xst -ifn xst.scr
move NexysClockGenerator_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\NexysClockGenerator_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc NexysClockGenerator_exdes.ucf NexysClockGenerator_exdes

echo 'Running map'
map -timing -pr b NexysClockGenerator_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm NexysClockGenerator_exdes -w routed.ncd routed.vhd
cd ..
